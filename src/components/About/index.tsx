...
const About = () => {
    return (
        <div className="p-4" id="about">
            ...
            <div className="max-w-[650px] mx-auto my-7 flex justify-between items-center flex-wrap">
                <Button btnclass='h-[50px] md:w-[250px] w-full' borderclass='rounded-lg' className='rounded-lg bg-[#D6DBDC] dark:bg-[#000000] hover:bg-opacity-80 dark:hover:bg-opacity-70 px-[10px] py-1 flex items-center justify-start gap-3 text-xs'>
                ...
                <Button btnclass='h-[50px] md:w-[360px] w-full' borderclass='rounded-lg' className='rounded-lg bg-[#D6DBDC] dark:bg-[#000000] hover:bg-opacity-80 dark:hover:bg-opacity-70 px-[10px] py-1 flex items-center justify-start gap-3 text-xs'>

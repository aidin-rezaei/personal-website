...
const Contact = () => {
    ...
    // console.profile()
    return (
        <div className=" w-full flex justify-center items-center flex-col" id="contact">
            <div className="w-full relative flex justify-center items-center ">
                ...
                <Button btnclass='h-[100%] w-[100%] w-full' className=' bg-[rgba(255,255,255,0.64)] dark:bg-[rgba(0,0,0,0.64)] flex justify-center items-center py-2 font-sans uppercase'>
                    <div className="max-w-[700px] w-full grid md:grid-cols-2 ">
                        ...
                        <div className="p-4 w-full  flex md:justify-end items-center gap-2">
                            <div className="hover:scale-105">
                                <a className='w-[50px] h-[50px] rounded-lg bg-[rgba(235,235,235,0.80)] dark:bg-[rgba(98,98,98,0.80)] hover:bg-opacity-80 dark:hover:bg-opacity-70 px-[10px] flex items-center justify-start flex-col gap-3 p-2 text-xs' href="https://www.instagram.com/aidinr.ir/" target="_blank" rel="noopener noreferrer">
                            ...
                            <div className="hover:scale-105">
                                <a className='w-[50px] h-[50px] rounded-lg bg-[rgba(235,235,235,0.80)] dark:bg-[rgba(98,98,98,0.80)] hover:bg-opacity-80 dark:hover:bg-opacity-70 px-[10px] flex items-center justify-start flex-col gap-3 p-2 text-xs' href="https://github.com/aidin-rezaei" target="_blank" rel="noopener noreferrer">
                            ...
                            <div className="hover:scale-105">
                                <a className='w-[50px] h-[50px] rounded-lg bg-[rgba(235,235,235,0.80)] dark:bg-[rgba(98,98,98,0.80)] hover:bg-opacity-80 dark:hover:bg-opacity-70 px-[10px] flex items-center justify-start flex-col gap-3 p-2 text-xs'  href="https://www.linkedin.com/in/aidinr/" target="_blank" rel="noopener noreferrer">
                            ...
                            <div className="hover:scale-105">
                                <a className='w-[50px] h-[50px] rounded-lg bg-[rgba(235,235,235,0.80)] dark:bg-[rgba(98,98,98,0.80)] hover:bg-opacity-80 dark:hover:bg-opacity-70 px-[10px] flex items-center justify-start flex-col gap-3 p-2 text-xs'  href="https://t.me/aidinr_ir/" target="_blank" rel="noopener noreferrer">

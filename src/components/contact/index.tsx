...
const Contact = () => {
    ...
    return (
        <div>
            <Button btnclass='h-[100%] w-[100%]w-full py-6' borderclass='rounded-2xl' className=' bg-[rgba(255,255,255,0.64)] dark:bg-[rgba(0,0,0,0.64)] flex justify-center items-center'>

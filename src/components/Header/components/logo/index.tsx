...
const Logo = ({ children }:any) => {
    ...
    return (
        <div className={`logo fixed pointer-events-none transition-all duration-500 fontsforweb_fontid_2802 top-0 left-0 ${classl ? " ml-[10px] text-lg  z-10" : "z-0 ml-[10%] mt-[calc(100%_/_5)] text-9xl after:content-[''] before:content-[''] before:absolute before:top-[220px] before:left-[100px] dark:before:shadow-[0_0_200px_120px_rgba(0,255,209,0.34)] before:-z-10  after:absolute after:-z-10 dark:after:shadow-[0_0_200px_120px_rgba(0,178,255,0.54)] after:shadow-[0_0_200px_120px_rgba(0,178,255,0.20)] before:shadow-[0_0_200px_120px_rgba(0,255,209,0.20)] after:left-[100%] after:top-[50%] after:rounded-full before:rounded-full"}`}>
            {children}
            <div className={`font-sans text-6xl -mt-10 flex justify-center items-center ${classl ? " hidden" : " opacity-100"}`}>
                <div className="w-[60px] mt-[38px] h-[40px] flex flex-col justify-between items-center">
                    <div className="w-[100%] h-[6px] rounded-xl transition-all duration-500 bg-black dark:bg-white"></div>
                    <div className="w-[100%] h-[6px] rounded-xl transition-all duration-500 bg-black dark:bg-white"></div>
                    <div className="w-[100%] h-[6px] rounded-xl transition-all duration-500 bg-black dark:bg-white"></div>
                </div>
                programmer
